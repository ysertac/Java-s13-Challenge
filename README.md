 ...
 * Encapsulation kurallarını doğru bir şekilde uygulamalısnız. Örneğin Employee için salary değeri hiçbir zaman negatif bir değer almamalı. Diğer değişkenler için de benzer kontrolleri yapmalısınız.
